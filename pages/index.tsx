            ...
            <Flex minWidth='max-content' alignItems='center' gap='2'>
              ...
              {loading ? (<></>) : (
                <Flex justifyContent="flex-end" marginLeft="auto">
                  <Box background={"#f9eccf"} borderRadius={"5px"} minWidth={"50px"} minHeight={"50px"} p={2} >
                    <VStack >
                      <Text fontSize={"sm"}>Available NFTs:</Text>
                      <Text fontWeight={"semibold"}>{Number(candyMachine?.data.itemsAvailable) - Number(candyMachine?.itemsRedeemed)}</Text>
                    </VStack>
                  </Box>
                </Flex>
              )}
  ...
  return (
      <main style={{ position: 'relative' }}>
        <div style={{
          ...
          height: '576px', // Adjust size as needed
          backgroundImage: 'url("https://guanteen.wtf/assets/packages/core/assets/artwork/artwork_5.svg")', // Replace with your image path
          backgroundSize: 'contain',
          backgroundRepeat: 'no-repeat',
          zIndex: -1,
          pointerEvents: 'none' // This prevents the image from interfering with clicks
        }} />
        ...
        <Box
            ...
            height="358px" // Adjust size as needed
            backgroundImage="https://guanteen.wtf/assets/packages/core/assets/artwork/artwork_6.svg"
            backgroundRepeat="no-repeat"
